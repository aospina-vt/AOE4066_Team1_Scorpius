...
%==================================================================
% Propulsion / Fuel Model (NEW)
%==================================================================

fuel_mass      = 3.0/Kg2slug;   % [slug] total propellant mass (example)
fuel_burn_rate = 0.15/Kg2slug;  % [slug/sec] constant burn rate (simple model)

t_burnout = fuel_mass / fuel_burn_rate;  % estimated burnout time [sec]

flight_mode = 1;  % 1 = powered, 2 = ballistic dive


%==================================================================
% Missile Aerodynamics
%==================================================================
Mach_vec  = 2:0.5:3;              % Reference Mach Numbers
...
v_ini      = 3*343;		% Initial velocity [m/s]
alpha_ini  = 0*d2r;		% Initial incidence [rad]
theta_ini  = -10*d2r;		% Initial Body Attitude [rad]
q_ini      = 0*d2r;		% Initial pitch rate [rad/sec]

%==================================================================
% Define Target 
%==================================================================
pos_tgt   = [1000 0]; % Initial Target position [m]
v_tgt     = 0;		% Target Velocity [m/s]
theta_tgt = 0*d2r;		% Target Direction [rad]
...
fin_max     =  15.0*d2r;        % Max Fin Deflection [rad] 
fin_min	    = -15.0*d2r;        % Min Fin Deflection [rad]
fin_maxrate = 100*d2r;          % Max Fin Rate [rad/sec]
